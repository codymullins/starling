...
{
    public static readonly IReadOnlyDictionary<string, CssColor> Map = new Dictionary<string, CssColor>(StringComparer.OrdinalIgnoreCase)
    {
    ...
    public static bool TryGet(string name, out CssColor color) => Map.TryGetValue(name, out color!);
}
